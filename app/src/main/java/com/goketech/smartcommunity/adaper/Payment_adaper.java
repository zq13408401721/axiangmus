...
public class Payment_adaper extends RecyclerView.Adapter<Payment_adaper.ViewHodler>  {
    private ArrayList<All_bean.DataBean> nei;
    private Context context;

    public Payment_adaper(ArrayList<All_bean.DataBean> nei, Context context) {
        this.nei = nei;
